{{-- <footer class="footer">
    <div class="footer-top row">
        <div class="footer-gt col-md-3 col-sm-6 col-xs-12">
            <h3>giới thiệu</h3>
        ...
        <div class="footer-dc col-md-3 col-sm-6 col-xs-12">
            <h3>địa chỉ</h3>
            <div class="footer-dc-1">
                <p>319 C16 Lý Thường Kiệt, Phường 15, Quận 11, Tp.HCM</p>
                <p>0978592275</p>
                <p>datnvph13011@gmail.com</p>
            </div>
        </div>
        <div style="margin-left: -30px" class="footer-mn col-md-3 col-sm-6 col-xs-12">
            <h3 style="margin-left: 30px;">menu</h3>
            <ul>
        ...
        <div class="footer-mxh col-md-3 col-sm-6 col-xs-12">
            <h3>mạng xã hội</h3>
            <div style="margin-left: -10px">
                ...
                <a href=""><img src="https://hotro.weba.vn/shop/images/hotro/Kho-ung-dung/Zalo-chat-tructuyen/Zalo.png" alt=""></a>
                <a href=""><img src="https://thuviendohoa.vn/upload/images/items/logo-youtube-nut-phat-youtube-png-385.webp" alt=""></a>
                <a href=""><img src="https://www.batdongsanhungphat.vn/wp-content/uploads/2021/10/twitter-logo-icon-vector-29228035.jpg" alt=""></a>
                <a href=""><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/768px-Instagram_logo_2016.svg.png" alt=""></a>
            </div>
        </div>
    </div>
    <div class="footer-bottom row">
        <div class="footer-dk col-md-6">
            <h3>đăng ký nhận thông tin</h3>
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="nhập email tại đây" aria-label="Recipient's username" aria-describedby="button-addon2">
                <button style="font-weight: bold;" class="btn btn-outline-secondary" type="button" id="button-addon2">ĐĂNG KÝ</button>
            </div>
        </div>
        <div class="footer-tt col-md-6">
            <h3>thanh toán</h3>
            <div>
                <a href=""><img src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment1.png" alt=""></a>
                <a href=""><img src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment2.png" alt=""></a>
                <a href=""><img src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment3.png" alt=""></a>
                <a href=""><img src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment4.png" alt=""></a>
                <a href=""><img src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment5.png" alt=""></a>
            </div>
        </div>
    </div>
    <div class="footer-copyright">
        <p>© Bản quyền thuộc về . Thiết kế website <strong>Nguyễn Văn Đạt</strong></p>
    </div>
</footer> --}}

<footer id="footer" class="footer-wrapper">

    <section class="section sec_footer dark" id="section_1460863149">
        ...
        <div class="section-content relative">
            ...
            <div class="row align-center row-top" id="row-1301248489">

                <div class="col medium-6 small-12 large-3">
                    <div class="col-inner">

                        <h3>GIỚI THIỆU</h3>
                        <div class="is-divider divider clearfix" style="max-width:35px;background-color:rgb(195, 0, 5);"></div><!-- .divider -->

                        <p>Chào mừng bạn đến với ngôi nhà Converse! Tại đây, mỗi một dòng chữ, mỗi chi tiết và
                            hình ảnh đều là những bằng chứng mang dấu ấn lịch sử Converse 100 năm, và đang không
                            ngừng phát triển lớn mạnh.</p>
...
C354.001,458.429,351.311,470.408,346.544,481.271z"></path>
    ...
    l-47.276,47.593h274.396L231.905,222.705z"></path>
                            ...
                            <div class="icon-box-text last-reset">
                                ...
                                <p><a href="/cdn-cgi/l/email-protection#5d393830323335283329382f3a1d3a303c3431733e3230"><span class="__cf_email__" data-cfemail="fd999890929395889389988f9abd9a909c9491d39e9290">[email&nbsp;protected]</span></a><br><a href="/cdn-cgi/l/email-protection#432e2c2d032e2c2d226d2e26272a22"><span class="__cf_email__" data-cfemail="d7bab8b997bab8b9b6f9bab2b3beb6">[email&nbsp;protected]</span></a>
                                </p>
...
C322.509,279.968,318.263,293.676,309.801,305.81z"></path>
                            ...
                            <div class="mona_sidebar_footer">
                                <div class="menu-menu-footer-company-container">
                                    <ul id="menu-menu-footer-company" class="menu">
                                        <li id="menu-item-361" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-16 current_page_item menu-item-361">
            ...
            <div class="row align-equal" id="row-248279503">
                ...
                <div class="col medium-7 small-12 large-4">
                    <div class="col-inner">

                        <div role="form" class="wpcf7" id="wpcf7-f88-o1" lang="vi" dir="ltr">
                            <div class="screen-reader-response"></div>
                            <form action="/converse/#wpcf7-f88-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                ...
                                <p><span class="wpcf7-form-control-wrap email-dang-ky"><input type="email" name="email-dang-ky" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form_dang_ky" id="email-dang-ky" aria-required="true" aria-invalid="false" placeholder="Email ..."></span><br>
                                    <input type="submit" value="Đăng ký" class="wpcf7-form-control wpcf7-submit form_dang_ky" id="btn-gui"><span class="ajax-loader"></span>
                                </p>
                ...
                <div class="col medium-6 small-12 large-4">
                    <div class="col-inner text-right">
                        ...
                        <div class="row large-columns-5 medium-columns-6 small-columns-5 row-collapse">
                            <div class="gallery-col col">
                                <div class="col-inner">
                                    <a class="image-lightbox lightbox-gallery" href="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment1.png" title="">
                                        <div class="box has-hover gallery-box box-none">
                                            <div class="box-image">
                                                <img width="94" height="34" src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment1.png" class="attachment-original size-original" alt="" ids="746,747,748,749,750" style="none" col_spacing="collapse" columns="5" columns__sm="5" columns__md="6" image_size="original">
                                            </div><!-- .image -->
                            ...
                            <div class="gallery-col col">
                                <div class="col-inner">
                                    <a class="image-lightbox lightbox-gallery" href="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment2.png" title="">
                                        <div class="box has-hover gallery-box box-none">
                                            <div class="box-image">
                                                <img width="74" height="34" src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment2.png" class="attachment-original size-original" alt="" ids="746,747,748,749,750" style="none" col_spacing="collapse" columns="5" columns__sm="5" columns__md="6" image_size="original">
                                            </div><!-- .image -->
                                            <div class="box-text text-left">
                                                <p></p>
                                            </div><!-- .text -->
                            ...
                            <div class="gallery-col col">
                                <div class="col-inner">
                                    <a class="image-lightbox lightbox-gallery" href="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment3.png" title="">
                                        <div class="box has-hover gallery-box box-none">
                                            <div class="box-image">
                                                <img width="64" height="34" src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment3.png" class="attachment-original size-original" alt="" ids="746,747,748,749,750" style="none" col_spacing="collapse" columns="5" columns__sm="5" columns__md="6" image_size="original">
                                            </div><!-- .image -->
                                            <div class="box-text text-left">
                                                <p></p>
                                            </div><!-- .text -->
                            ...
                            <div class="gallery-col col">
                                <div class="col-inner">
                                    <a class="image-lightbox lightbox-gallery" href="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment4.png" title="">
                                        <div class="box has-hover gallery-box box-none">
                                            <div class="box-image">
                                                <img width="79" height="34" src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment4.png" class="attachment-original size-original" alt="" ids="746,747,748,749,750" style="none" col_spacing="collapse" columns="5" columns__sm="5" columns__md="6" image_size="original">
                                            </div><!-- .image -->
                                            <div class="box-text text-left">
                                                <p></p>
                                            </div><!-- .text -->
                            ...
                            <div class="gallery-col col">
                                <div class="col-inner">
                                    <a class="image-lightbox lightbox-gallery" href="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment5.png" title="">
                                        <div class="box has-hover gallery-box box-none">
                                            <div class="box-image">
                                                <img width="70" height="34" src="http://mauweb.monamedia.net/converse/wp-content/uploads/2019/05/payment5.png" class="attachment-original size-original" alt="" ids="746,747,748,749,750" style="none" col_spacing="collapse" columns="5" columns__sm="5" columns__md="6" image_size="original">
                                            </div><!-- .image -->
                                            <div class="box-text text-left">
                                                <p></p>
                                            </div><!-- .text -->
        ...
        <div class="container clearfix">
            ...
            <div class="footer-primary pull-left">
                <div class="copyright-footer">
                    © Bản quyền thuộc về <công ty="" khách="" hàng="">. Thiết kế website <img src="http://mona-media.com/logo.png" style="width:20px;vertical-align:sub;" alt="MonaMedia"> <a href=" " title="Mona Media"><strong>Mona Media</strong></a>
                </công></div>
            </div><!-- .left -->
        </div><!-- .container -->
    </div><!-- .absolute-footer -->
